...
interface DigitalDocumentsProps {
  documents: Document[]
}

export function DigitalDocuments({ documents }: DigitalDocumentsProps) {
  const typeConfig = {
    exam: {
      label: "Exame",
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-card shadow-sm shrink-0">
                  ...
                  <div className="flex items-center gap-2 mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button variant="secondary" size="sm" className="h-8 text-xs flex-1">
